...
```
####Interpretation: 
1. Licor1 2 refers to which licor was used for respirometry on Day 11 (Li_cor1) and Day 15 (Li_cor2). This was recorded in 2017 In 2018 there are no records for which licor was used on Day 15 - this is the missing Li_cor2 column. Probably will not matter...

2. Year 2 fridge and 'SO' columns appear to be irrelevant - no flies entered a second year of diapause. 

3. mass_day19, purge_time_3, resp_time_3, and resp_day20 are all related to taking respirometry measures a 3rd time 
  +Day 19 used on RT and some GC flies - not SO b/c they are in fridge by that point. 
  +Will not affect main analyses - day 15 is the relevant time point. 
4. Entrainment enter date is the same as eclosion date in 2017. 
  +2017 does not have entrainment enter date - must be inferred from eclosion records. 

####Actions
1. Most of the mismatched columns are not necessary for main analyses; metabolic rate analyses are separate
...
The 1304 NAs are animals that have no eclosion date. Presumably dead. 
...
*Write new datasheet to excel file. 
